...
#include <memory>
#include "../../OOAIA_Project/Text_Editor_Widget/TextEdit.h"
...
QT_MOC_LITERAL(1, 9, 10), // "insertword"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 10) // "completion"

    },
    "TextEdit\0insertword\0\0completion"
};
...
void TextEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->insertword((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
